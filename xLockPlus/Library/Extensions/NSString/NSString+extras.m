...
- (NSUInteger)countSubstring:(NSString *)aString ignoringCase:(BOOL)flag {
    unsigned mask = (flag ? NSCaseInsensitiveSearch : 0);
...
- (CGSize)expectedSize:(UIFont*)font maxSize:(CGSize)size{
    ...
    CGRect expectedLabelRect = [self boundingRectWithSize:size options:(NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading)
